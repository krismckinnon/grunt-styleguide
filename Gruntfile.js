...
module.exports = function(grunt) {
        ...
        styleguide: {
            ...
            styledocco: {
                ...
                files: {
                    ...
                    '<%= task.tmp %>/styledocco/docs/bootstrap/sass': 'testcss/**/*.{scss,sass}'
                }
            ...
            kss: {
                ...
                files: {
                    '<%= task.tmp %>/kss/docs/less': 'testcss/**/*.less',
                    '<%= task.tmp %>/kss/docs/sass': 'testcss/**/*.{scss,sass}'
                }
    ...
    //grunt.registerTask('default', 'jshint test'.split(' '));
     ...
     grunt.registerTask('default', 'clean styleguide'.split(' '));

      grunt.registerTask('styledocco', 'clean styleguide'.split(' '));
